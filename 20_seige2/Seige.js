...
//wall
    ...
    function setlocationstuff(){
        ...
        $("#space13").data("move1",'14').data("move2",'30').data("move3",'36').data("move4",'').data("left",345).data("top",100).data("location",13).data("fortify",false); $("#space14").data("move1",'15').data("move2",'13').data("move3",'31').data("move4",'37').data("left",345).data("top",160).data("location",14).data("fortify",false);
...
$(window).load(function(){
    ...
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C3" style="left:105px; top:340px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C4" style="left:105px; top:400px" />');
    
    $("#C1").data("top",220).data("left",105).data("index",1).data("location",3)
    $("#C2").data("top",280).data("left",105).data("index",2).data("location",4)
    $("#C3").data("top",340).data("left",105).data("index",3).data("location",5)
    $("#C4").data("top",400).data("left",105).data("index",4).data("location",6)
    
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C5" style="left:220px; top:220px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C6" style="left:220px; top:280px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C7" style="left:220px; top:340px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C8" style="left:220px; top:400px" />');
    
    $("#C5").data("top",220).data("left",220).data("index",5).data("location",9)
    $("#C6").data("top",280).data("left",220).data("index",6).data("location",10)
    $("#C7").data("top",340).data("left",220).data("index",7).data("location",11)
    $("#C8").data("top",400).data("left",220).data("index",8).data("location",12)
    
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C9" style="left:345px; top:220px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C10" style="left:345px; top:280px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C11" style="left:345px; top:340px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C12" style="left:345px; top:400px" />');
    
    $("#C9").data("top",220).data("left",345).data("index",9).data("location",15)
    $("#C10").data("top",280).data("left",345).data("index",10).data("location",16)
    $("#C11").data("top",340).data("left",345).data("index",11).data("location",17)
    $("#C12").data("top",400).data("left",345).data("index",12).data("location",18)
    
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C13" style="left:445px; top:220px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C14" style="left:445px; top:280px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C15" style="left:445px; top:340px" />');
    $('#background').append('<img src="pics/diamond.gif" class="crystal" id="C16" style="left:445px; top:400px" />');
    
    $("#C13").data("top",220).data("left",445).data("index",13).data("location",21)
    $("#C14").data("top",280).data("left",445).data("index",14).data("location",22)
    $("#C15").data("top",340).data("left",445).data("index",15).data("location",23)
    $("#C16").data("top",400).data("left",445).data("index",16).data("location",24)
